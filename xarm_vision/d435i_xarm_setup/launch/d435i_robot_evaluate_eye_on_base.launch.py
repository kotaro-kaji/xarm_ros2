...
def launch_setup(context, *args, **kwargs):
    ...
    marker_size = LaunchConfiguration('marker_size', default=0.09615)
    ...
    robot_moveit_real_launch = IncludeLaunchDescription(
    ...
    easy_handeye_eval_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('easy_handeye2'), 'launch', 'evaluate.launch.py'])),
        launch_arguments={
            'name': calib_filename,
        }.items(),
    )
    easy_handeye_publish_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('easy_handeye2'), 'launch', 'publish.launch.py'])),
        launch_arguments={
            'name': calib_filename,
        }.items(),
    )
    ...
    return [
        rs_camera_launch,
        aruco_single,
        robot_moveit_real_launch,
        easy_handeye_publish_launch,
        easy_handeye_eval_launch,
        recognition_view,
    ]
